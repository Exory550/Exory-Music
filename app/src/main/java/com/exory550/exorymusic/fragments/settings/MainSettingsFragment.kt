...
import com.exory550.exorymusic.databinding.FragmentMainSettingsBinding
import com.exory550.exorymusic.extensions.drawAboveSystemBarsWithPadding
    ...
    override fun onClick(view: View) {
        findNavController().navigate(
            when (view.id) {
                ...
                R.id.imageSettings -> R.id.action_mainSettingsFragment_to_imageSettingsFragment
                ...
                R.id.backupRestoreSettings -> R.id.action_mainSettingsFragment_to_backupFragment
