...
import com.exory550.exorymusic.EXTRA_PLAYLIST_ID
import com.exory550.exorymusic.R
import com.exory550.exorymusic.adapter.playlist.PlaylistAdapter
import com.exory550.exorymusic.db.PlaylistWithSongs
import com.exory550.exorymusic.fragments.ReloadType
import com.exory550.exorymusic.fragments.base.AbsRecyclerViewCustomGridSizeFragment
...
class PlaylistsFragment :
    ...
    private fun setUpSortOrderMenu(subMenu: SubMenu) {
        ...
        subMenu.clear()
        subMenu.add(0, R.id.action_song_sort_order_asc, 0, R.string.sort_order_a_z).isChecked = order == PlaylistSortOrder.PLAYLIST_A_Z
        subMenu.add(0, R.id.action_song_sort_order_desc, 0, R.string.sort_order_z_a).isChecked = order == PlaylistSortOrder.PLAYLIST_Z_A
        subMenu.add(0, R.id.action_playlist_sort_order, 0, R.string.sort_order_num_songs).isChecked = order == PlaylistSortOrder.PLAYLIST_SONG_COUNT
        subMenu.add(0, R.id.action_playlist_sort_order_desc, 0, R.string.sort_order_num_songs_desc).isChecked = order == PlaylistSortOrder.PLAYLIST_SONG_COUNT_DESC
