package com.exory550.exorymusic.fragments.player.circle
...
import com.exory550.exorymusic.fragments.MusicSeekSkipTouchListener
...
import com.exory550.exorymusic.glide.ExoryMusicGlideExtension.simpleSongCoverOptions
import com.exory550.exorymusic.glide.crossfadeListener
...
class CirclePlayerFragment : AbsPlayerFragment(R.layout.fragment_circle_player), Callback,
    ...
    private fun updateSong() {
        ...
        Glide.with(this)
            .load(ExoryMusicGlideExtension.getSongModel(MusicPlayerRemote.currentSong))
