package com.exory550.exorymusic.fragments.home
...
import com.exory550.exorymusic.dialogs.ImportPlaylistDialog
import com.exory550.exorymusic.extensions.accentColor
import com.exory550.exorymusic.extensions.dip
import com.exory550.exorymusic.extensions.elevatedAccentColor
...
import com.exory550.exorymusic.glide.ExoryMusicGlideExtension.profileBannerOptions
import com.exory550.exorymusic.glide.ExoryMusicGlideExtension.songCoverOptions
import com.exory550.exorymusic.glide.ExoryMusicGlideExtension.userProfileOptions
...
import com.exory550.exorymusic.util.PreferenceUtil.userName
...
class HomeFragment :
    ...
    private fun loadProfile() {
        binding.bannerImage?.let {
            Glide.with(requireContext())
                .load(ExoryMusicGlideExtension.getBannerModel())
                .profileBannerOptions(ExoryMusicGlideExtension.getBannerModel())
                .into(it)
        }
        Glide.with(requireActivity())
            .load(ExoryMusicGlideExtension.getUserModel())
            .userProfileOptions(ExoryMusicGlideExtension.getUserModel(), requireContext())
    ...
    private fun loadSuggestions(songs: List<Song>) {
        ...
        images.forEachIndexed { index, imageView ->
            ...
            Glide.with(this)
                .load(ExoryMusicGlideExtension.getSongModel(songs[index]))
