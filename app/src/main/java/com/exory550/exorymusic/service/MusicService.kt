...
import com.exory550.exorymusic.appwidgets.*
import com.exory550.exorymusic.auto.AutoMediaIDHelper
import com.exory550.exorymusic.auto.AutoMusicProvider
import com.exory550.exorymusic.extensions.showToast
import com.exory550.exorymusic.extensions.toMediaSessionQueue
import com.exory550.exorymusic.extensions.uri
import com.exory550.exorymusic.glide.BlurTransformation
import com.exory550.exorymusic.glide.ExoryMusicGlideExtension.getSongModel
...
import com.exory550.exorymusic.model.Song.Companion.emptySong
import com.exory550.exorymusic.model.smartplaylist.AbsSmartPlaylist
import com.exory550.exorymusic.providers.HistoryStore
import com.exory550.exorymusic.providers.MusicPlaybackQueueStore
import com.exory550.exorymusic.providers.SongPlayCountStore
import com.exory550.exorymusic.service.notification.PlayingNotification
import com.exory550.exorymusic.service.notification.PlayingNotificationClassic
import com.exory550.exorymusic.service.notification.PlayingNotificationImpl24
...
import com.exory550.exorymusic.util.MusicUtil.toggleFavorite
import com.exory550.exorymusic.util.PackageValidator
import com.exory550.exorymusic.util.PreferenceUtil.crossFadeDuration
import com.exory550.exorymusic.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.exory550.exorymusic.util.PreferenceUtil.isBluetoothSpeaker
import com.exory550.exorymusic.util.PreferenceUtil.isBlurredAlbumArt
import com.exory550.exorymusic.util.PreferenceUtil.isClassicNotification
import com.exory550.exorymusic.util.PreferenceUtil.isHeadsetPlugged
import com.exory550.exorymusic.util.PreferenceUtil.isLockScreen
import com.exory550.exorymusic.util.PreferenceUtil.isPauseOnZeroVolume
...
import com.exory550.exorymusic.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.exory550.exorymusic.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.exory550.exorymusic.volume.AudioVolumeObserver
import com.exory550.exorymusic.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    override fun onCreate() {
        ...
        restoreState()
        sendBroadcast(Intent("$EXORY_MUSIC_PACKAGE_NAME.EXORY_MUSIC_SERVICE_CREATED"))
    ...
    override fun onDestroy() {
        ...
        wakeLock?.release()
        sendBroadcast(Intent("$EXORY_MUSIC_PACKAGE_NAME.EXORY_MUSIC_SERVICE_DESTROYED"))
    }
    ...
    fun sendPublicIntent(what: String) {
        val intent = Intent(what.replace(EXORY_MUSIC_PACKAGE_NAME, MUSIC_PACKAGE_NAME))
        ...
        intent.putExtra("scrobbling_source", EXORY_MUSIC_PACKAGE_NAME)
        @Suppress("Deprecation")
    ...
    companion object {
        ...
        const val EXORY_MUSIC_PACKAGE_NAME = "com.exory550.exorymusic"
        const val MUSIC_PACKAGE_NAME = "com.android.music"
        const val ACTION_TOGGLE_PAUSE = "$EXORY_MUSIC_PACKAGE_NAME.togglepause"
        const val ACTION_PLAY = "$EXORY_MUSIC_PACKAGE_NAME.play"
        const val ACTION_PLAY_PLAYLIST = "$EXORY_MUSIC_PACKAGE_NAME.play.playlist"
        const val ACTION_PAUSE = "$EXORY_MUSIC_PACKAGE_NAME.pause"
        const val ACTION_STOP = "$EXORY_MUSIC_PACKAGE_NAME.stop"
        const val ACTION_SKIP = "$EXORY_MUSIC_PACKAGE_NAME.skip"
        const val ACTION_REWIND = "$EXORY_MUSIC_PACKAGE_NAME.rewind"
        const val ACTION_QUIT = "$EXORY_MUSIC_PACKAGE_NAME.quitservice"
        const val ACTION_PENDING_QUIT = "$EXORY_MUSIC_PACKAGE_NAME.pendingquitservice"
        const val INTENT_EXTRA_PLAYLIST = EXORY_MUSIC_PACKAGE_NAME + "intentextra.playlist"
        const val INTENT_EXTRA_SHUFFLE_MODE =
            "$EXORY_MUSIC_PACKAGE_NAME.intentextra.shufflemode"
        const val APP_WIDGET_UPDATE = "$EXORY_MUSIC_PACKAGE_NAME.appwidgetupdate"
        const val EXTRA_APP_WIDGET_NAME = EXORY_MUSIC_PACKAGE_NAME + "app_widget_name"

        const val META_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.metachanged"
        const val QUEUE_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.queuechanged"
        const val PLAY_STATE_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.playstatechanged"
        const val FAVORITE_STATE_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.favoritestatechanged"
        const val REPEAT_MODE_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.repeatmodechanged"
        const val SHUFFLE_MODE_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.shufflemodechanged"
        const val MEDIA_STORE_CHANGED = "$EXORY_MUSIC_PACKAGE_NAME.mediastorechanged"
        const val CYCLE_REPEAT = "$EXORY_MUSIC_PACKAGE_NAME.cyclerepeat"
        const val TOGGLE_SHUFFLE = "$EXORY_MUSIC_PACKAGE_NAME.toggleshuffle"
        const val TOGGLE_FAVORITE = "$EXORY_MUSIC_PACKAGE_NAME.togglefavorite"
