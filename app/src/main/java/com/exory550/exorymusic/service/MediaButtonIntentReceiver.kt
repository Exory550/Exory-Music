...
import com.exory550.exorymusic.service.MusicService.Companion.ACTION_PAUSE
import com.exory550.exorymusic.service.MusicService.Companion.ACTION_PLAY
...
import com.exory550.exorymusic.service.MusicService.Companion.ACTION_STOP
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "ExoryMusicApp:Wakelock headset button"
                )
