package com.exory550.exorymusic.activities.bugreport
...
import com.exory550.exorymusic.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        private const val ISSUE_TRACKER_LINK =
            "https://github.com/Exory550/Exory-Music/issues/new"
    }
}
